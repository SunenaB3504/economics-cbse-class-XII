...
export const SQP_QUESTIONS: SQPQuestion[] = [
  {
    id: 'u5-q1-sqp-22-23-q4',
    year: '2022-23',
    paperType: 'SQP',
    marks: 1,
    type: 'MCQ',
    questionNumber: '4.',
    question: 'Gifts and remittances from abroad are recorded in which account of the Balance of Payments?',
    markingScheme: 'These are recorded in the **Current Account** as Unilateral Transfers.',
    aiExplanation: 'Teacher\'s Voice: Gifts, donations, and remittances are "one-way" transactions. Since they don\'t create any liability or change in assets, they go to the Current Account.'
  },
  {
    id: 'u5-q2-sqp-22-23-q10',
    year: '2022-23',
    paperType: 'SQP',
    marks: 3,
    type: 'SA',
  ...
  },
  {
    ...
    type: 'MCQ',
    questionNumber: '4.',
    question: 'Trade in goods is also known as __________ Trade.',
    markingScheme: 'Visible Trade.',
    aiExplanation: 'Goods are physical items that can be seen and touched (like oil, mobile phones), which is why we call it Visible Trade.'
  },
  {
    id: 'u5-q6-sqp-24-25-q13',
    year: '2024-25',
    paperType: 'SQP',
    marks: 4,
    type: 'SA',
    questionNumber: '13.',
    question: 'Discuss why "Managed Floating" is often called a "Dirty Float".',
    markingScheme: '1. Definition: It is a system where the rate is market-determined but the Central Bank intervenes to limit volatility.\n2. Reason: It is called "Dirty" because it is an "impure" version of floating - governments often manipulate the rate secretly to gain trade advantages.',
    aiExplanation: 'It\'s like a "rigged" race. The market is running, but the referee (Central Bank) occasionally pushes a runner to keep the speed where they want it.'
  },
  {
    id: 'u5-q7-sqp-25-26-q4',
    year: '2025-26',
    paperType: 'SQP',
    marks: 1,
    type: 'MCQ',
    questionNumber: '4.',
    question: 'A surplus in the BoP occurs when __________.',
    markingScheme: 'Autonomous Receipts > Autonomous Payments.',
    aiExplanation: 'When our "Above the Line" earnings exceed our "Above the Line" spending, we have a surplus that ends up being added to our official reserves.'
  },
  {
    id: 'u5-q8-sqp-25-26-q17',
    year: '2025-26',
    paperType: 'SQP',
    marks: 4,
    type: 'SA',
