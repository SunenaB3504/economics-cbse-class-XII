...
export const SQP_QUESTIONS: SQPQuestion[] = [
  ...
  },
  {
    ...
    aiExplanation: 'Teacher\'s Voice: This is the "Treading Water" scenario. You aren\'t digging a new hole, but you are still paying for the old one.'
  },
  {
    id: 'u4-q4-board-2024',
    year: '2024-25',
    ...
    aiExplanation: 'Teacher\'s Voice: If I can use the street light for free, why would I ever pay a private company to build one? That\'s why the Government must step in!'
  },
  {
    id: 'u4-q5-sqp-2024',
    year: '2024-25',
    ...
    aiExplanation: 'Teacher\'s Voice: High Fiscal Deficit is like a heavy credit card bill. It might solve today\'s hunger but will be a nightmare tomorrow when interest starts piling up.'
  },
  {
    id: 'u4-q6-board-2023',
    year: '2022-23',
    ...
    aiExplanation: 'Think of Primary Deficit as "Today\'s Overspending". If it is zero, you are only paying for yesterday\'s mistakes (past loans).'
  },
  {
    id: 'u4-q7-board-2024',
    year: '2023-24',
